...
def predict_burnout(df):
    try:
        add = open('C:\\Users\\ShadyAK\\Desktop\\Sap_Labs\\models_and_pipelines\\burnout_rate\\saved_models/burnout','rb')
...
def predict_fatigue(df):
    try:
        add = open('C:\\Users\\ShadyAK\\Desktop\\Sap_Labs\\models_and_pipelines\\burnout_rate\\saved_models/fatigue','rb')
